...
if (u.includes('?') || u.includes('q=') || u.includes('p=') || u.includes('v=')) {
    if (u.includes('app')) {
        ...
        document.body.innerHTML = `
            ...
            <a class='btnanima' href='//www.facebook.com/groups/1925174917947482' style='width: auto;padding: 5px;z-index: 999999999;margin: 10px 0;text-decoration: none;color: #fff;background: #0f66dd;border-radius: 7px; text-align: center;'>&#10084;💕${getVideos()}😘👌</a>
            <div id='videoBox'>
